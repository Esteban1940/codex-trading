...
const envSchema = z.object({
  ...
  ALLOCATOR_CONVICTION_SCALING: z.string().default("true").transform((v) => v === "true"),
  ALLOCATOR_CONVICTION_MIN_SCALE: z.coerce.number().default(0.35),
  ...
  SIGNAL_MIN_FAST_CANDLES: z.coerce.number().default(80),
  SIGNAL_MIN_SLOW_CANDLES: z.coerce.number().default(80),
  ...
  WORKER_ERROR_BACKOFF_MS: z.coerce.number().default(5000),
  WORKER_ERROR_BACKOFF_JITTER_MS: z.coerce.number().default(500),
  WORKER_MAX_CONSECUTIVE_ERRORS: z.coerce.number().default(10),
